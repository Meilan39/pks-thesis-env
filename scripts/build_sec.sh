#!/usr/bin/env bash
# ==============================================================================
# scripts/build_sec.sh - Compile security-hardened dev kernel with PKS diagnostics
# ==============================================================================
set -euo pipefail
...
log_header "Building Security Kernel (build_sec)"
...
if [ -f "$BZIMAGE" ]; then
    log_ok "Security kernel build complete: $BZIMAGE"
else
